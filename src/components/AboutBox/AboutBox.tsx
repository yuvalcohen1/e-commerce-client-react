...
const AboutBox: FC<Props> = (props) => {
  return (
    <div id="about-box">
      <img src="https://images.unsplash.com/photo-1628102491629-778571d893a3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" />
      <div id="about-para">
